...
\begin{table}[htb]
  \centering
  \IBGEtab{
    \caption{Comparação percentual de MSE para a fonte hidráulica}
...
\begin{table}[htb]
  \centering
  \IBGEtab{
    \caption{Comparação percentual de MSE para a fonte eólica}
    ...
    \begin{tabular}{lcccc}
      ...
      \textbf{Modelo} & \textbf{Linear} & \textbf{Não Linear} & \textbf{Neural Oneshot} & \textbf{Neural Finetune} \\
      \midrule
      Linear & -- & +232,91\% & -360,36\% & -383,23\% \\
      Não Linear & -232,91\% & -- & +93,47\% & +93,78\% \\
      Neural Oneshot & +78,28\% & -93,47\% & -- & +4,73\% \\
      Neural Finetune & +79,31\% & -93,78\% & -4,97\% & -- \\
      \bottomrule
    \end{tabular}
  }{\fonte{o autor.}}
\end{table}
\begin{table}[htb]
  \centering
  \IBGEtab{
    \caption{Comparação percentual de MSE para a fonte térmica}
    ...
    \begin{tabular}{lcccc}
      ...
      \textbf{Modelo} & \textbf{Linear} & \textbf{Não Linear} & \textbf{Neural Oneshot} & \textbf{Neural Finetune} \\
      \midrule
      Linear & -- & -210,26\% & -630,02\% & -662,20\% \\
      Não Linear & +67,77\% & -- & +57,50\% & +59,29\% \\
      Neural Oneshot & +86,30\% & -135,29\% & -- & +4,22\% \\
      Neural Finetune & +86,88\% & -145,67\% & -4,41\% & -- \\
      \bottomrule
    \end{tabular}
  }{\fonte{o autor.}}
\end{table}