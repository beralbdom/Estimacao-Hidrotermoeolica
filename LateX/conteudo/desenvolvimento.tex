...
Esta seção detalha as etapas fundamentais de aquisição e preparação dos dados que servem como base para o estudo. Primeiramente, 
descreve-se o processo de obtenção das séries históricas de dados energéticos (geração e carga) e dos dados climáticos (ENSO) de 
